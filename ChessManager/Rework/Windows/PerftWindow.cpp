...
PerftWindow::PerftWindow(std::string name, const Chess_Rework::Chessboard_New& board) noexcept :
...
std::uint64_t PerftWindow::perft(Chess_Rework::Chessboard_New& Board, int Depth, std::stop_token st)
{
